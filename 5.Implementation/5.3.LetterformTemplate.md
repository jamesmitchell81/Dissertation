...
The square tracing algorithm will fail to to trace an 8-connected structures that isn't 4 connected.
...
The Moore-neighbor algorithm named as such due to its use of the Moore neighborhood being the 8 connected neighbors (p1, p2 ..., p8) around a point (p0).
...
Figure shows the 8 neighbors of p0 are ordered p1, p2, ..., p8 and represents the order in which considered pixels around p0 are visited.

![80: Working of Moore Neighbor tracing algorithm. (Samet and Hancer, 2012)](../-img/5.3.working-mn.png)
...
```
<figure>Figure 81: Moore’s Neighbor tracing algorithm (Rajashekar Reddy, Amarnadh, and Bhaskar, 2012)</figure>
</figure>
...
![Figure 86: Starting letterform subject (thresholded to remove aliasing)](../-img/5.3.trace-start.png)
